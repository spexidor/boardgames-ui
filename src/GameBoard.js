...
import { UpdateMonster , UpdateMonsterAI, GetAiDeck, GetTargets, GetMonsterMoves } from './RestServices/Monster';
...
export default class GameBoard extends Component {
  ...
  keyFunction = (event) => {
   ...
   else if(event.keyCode===53){ //monster at 5
    this.selectMonster();
   }
 }
